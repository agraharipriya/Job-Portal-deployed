    ...
    <div className="card-container">
            <div className="card">
                <div className="card-header">
                    <img className='company-logo' src={`https://logo.clearbit.com/${jobData[0].company.display_name}.com`} alt="Company Logo" />
                    <div className="job-details">
                        <div className="job-title">{jobData[0].title}</div>
                        <div className="job-location">{`${jobData[0].location.area[0] || ''}${jobData[0].location.area[1] ? ', ' + jobData[0].location.area[1] : ''}${jobData[0].location.area[2] ? ', ' + jobData[0].location.area[2] : ''}`}</div>
                        <div className="job-id">Job ID: {jobData[0].id}</div>
                    </div>
                </div>
                <div className="card-description">
                    <div className="scrollable-description">{jobData[0].description}</div>
                </div>
                <Link to="/jobs/apply">
